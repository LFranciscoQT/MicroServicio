...
public class EscritoresController 
{
    ...
    public ResponseEntity<Escritores> actualizarEscritores(@PathVariable("id") Long id, @RequestBody Escritores entity)
    {
        return escritoresService.actualizarEscritores(id, entity);
    }
}
